...
/**
 * @file k4a_sdk_wrapper.h
 * @brief 4KA camera SDK interface
 */

#pragma once

#ifdef K4ASDKWRAPPER_EXPORTS
#define K4ASDKWRAPPER_API __declspec(dllexport)
#else
#define K4ASDKWRAPPER_API __declspec(dllimport)
#endif
 ...
 */
class K4ASDKWRAPPER_API K4aSdkWrapper
{
...
private:
	...
	*/
	struct K4aCameraParamInfo
	{
		...
		unsigned long long product_number;	/**< nProductNumber; */
	...
	K4aCameraParamInfo k4a_camera_param_info_;	/**< camera parameters */
