...
#pragma comment (lib, "ISCSDKLibvm200")
...
VmSdkWrapper::VmSdkWrapper()
	:vm_camera_param_info_(), isc_grab_start_mode_(), isc_shutter_mode_(IscShutterMode::kManualShutter), isc_image_info_(), decode_buffer_()
{
...
int VmSdkWrapper::ReleaeIscIamgeinfo(IscImageInfo* isc_image_info)
{
	...
	isc_image_info->color.height = 0;
	isc_image_info->color.channel_count = 0;
	assert(isc_image_info->color.image == nullptr);
	isc_image_info->color.image = nullptr;
