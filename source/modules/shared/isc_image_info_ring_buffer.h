...
/**
	@file isc_image_info_ring_buffer.h
 ...
 * this class is an buffer for camera control
 */
class IscImageInfoRingBuffer {
public:
	...
	struct BufferData {
		...
		IscImageInfo isc_image_info;	/**< images */
	};

	IscImageInfoRingBuffer();
	~IscImageInfoRingBuffer();
